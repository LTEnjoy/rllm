...
# c.NotebookApp.ip = '0.0.0.0'
# c.NotebookApp.open_browser = False
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$e6JCQlQl0lXUcrHd/Hzykw$uErzEXc/6DEx2nVG3thTYFFIKTila3D5v1//dr7u2eA' # snfypcq123!
c.NotebookApp.notebook_dir = "/root/PycharmProjects/rllm/notebooks/src"
c.ServerApp.token = ''
c.NotebookApp.base_url = ''
